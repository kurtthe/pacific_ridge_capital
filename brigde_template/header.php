 ...
 ">
  <div class="container">
     ...
     ">
      ...
      padding: 0px 10px;
      text-align: center;
     "><img alt="" src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/icon-fast.png" style="
      display: inline-block;
      vertical-align: middle;
      width: 22px;
      margin-right: 4px;
     "><a href="https://www.skinmatrix.com.au/delivery-information/" style="
      vertical-align: middle;
     ">Order Before 1pm for same day dispatch</a></li>
          <li style="
      display: inline-block;
      padding: 0px 10px;
      text-align: center;
     "><img alt="" src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/icon-price.png" style="
      display: inline-block;
      vertical-align: middle;
      width: 22px;
      margin-right: 4px;
     "><a href="https://www.skinmatrix.com.au/best-price-guarantee/" style="display: inline-block;vertical-align: middle;">Price match guarantee</a></li>
          <li class="icon3" style="
      display: inline-block;
      padding: 0px 10px;
      text-align: center;
     "><img alt="" src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/icon-free.png" style="
      display: inline-block;
      vertical-align: middle;
      width: 22px;
      margin-right: 4px;
     "><a href="https://www.skinmatrix.com.au/delivery-information/" style="
      display: inline-block;
      vertical-align: middle;
     ">Free delivery on orders over $99</a></li>
          <li class="" style="
      display: inline-block;
      padding: 0px 10px;
      text-align: center;
     "><img src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/free-samples.png" alt="" style="
      display: inline-block;
      vertical-align: middle;
      width: 20px;
      margin-right: 5px;
     "><a href="https://www.skinmatrix.com.au/freesamples/" style="
      display: inline-block;
      vertical-align: middle;
     ">Free samples</a></li>
          <li style="
      ...
      padding: 0px 10px;
      text-align: center;
     "><img alt="" src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/icon-loylty.png" style="
      display: inline-block;
      vertical-align: middle;
      width: 22px;
      margin-right: 4px;
     "><a href="https://www.skinmatrix.com.au/loyalty-program/" style="
      display: inline-block;
      vertical-align: middle;
     ">Loyalty Programme</a></li>
      ...
      padding: 0px 10px;
      text-align: center;
     "><img alt="" src="https://www.skinmatrix.com.au/media/wysiwyg/alothemes/gift_voucher_icon.png" style="
      display: inline-block;
      vertical-align: middle;
     "><a href="https://www.skinmatrix.com.au/gift-product/" style="
      display: inline-block;
      vertical-align: middle;
     ">Gift Vouchers</a></li>
          </ul>
